	...
	case '+':
		if (shape == 5 && !isEraser)
		{
			...
			else
			{
				...
				timeinfo = localtime(&rawtime);
				 cout << asctime(timeinfo)
						  << "[Warning] El tamaño del pincel esta al maximo. No puede ser mas grande.\n";
			}
		}
		else if (isEraser)
		{
			...
			else
			{
				...
				timeinfo = localtime(&rawtime);
				 cout << asctime(timeinfo)
						  << "[Warning] El tamaño del borrador esta al maximo. No puede ser mas grande.\n";
			}
		}
		break;
	case '-':
		if (shape == 5 && !isEraser)
		{
			...
			else
			{
				...
				timeinfo = localtime(&rawtime);
				 cout << asctime(timeinfo)
						  << "[Warning] El tamaño del pincel esta al minimo. No puede ser mas pequeño.\n";
			}
		}
		else if (isEraser)
		{
			...
			else
			{
				...
				timeinfo = localtime(&rawtime);
				 cout << asctime(timeinfo)
						  << "[Warning] El tamaño del borrador esta al minimo. No puede ser mas pequeño.\n";
			}
		}
		break;
	case 'u':
